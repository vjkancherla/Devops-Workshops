...
terraform {
  backend "s3" {
    ...
    key    = "project6_1-000compute.tfstate"
    region = "eu-west-1"
  }
...
resource "aws_instance" "jenkins-instance" {
  ...
  provisioner "local-exec" {
    ...
    export ANSIBLE_HOST_KEY_CHECKING=False;
	  ansible-playbook -i jenkins-ci.ini ../../../Ansible/jenkins/provision-jenkins.yml --vault-password-file=/Users/vija0326/Downloads/vault-pwd.txt
    rm jenkins-ci.ini
EOT
  }
}
